            ...
            <div className="lg:w-1/2 md:w-2/3 mx-auto">
              <div className="flex flex-wrap -m-2">
                ...
                <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
                  ...
                  <span className="inline-flex pt-8">
                  <a rel="noopener noreferrer" href="https://github.com/vaishnavibadwaik24" title="GitHub" className="flex items-center justify-center w-10 h-10 rounded-full text-gray-50 bg-fuchsia-600">
